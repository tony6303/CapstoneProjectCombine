...
public class WriteConn extends AsyncTask<String, Void, String> {
    String sendMsg, receiveMsg;

    @Override
    protected String doInBackground(String... strings) {
        //Log.d("확인 WriteConn","ㅎㅎ");
        try{
            String str;
            ...
            sendMsg = "id="+strings[0]+"&date="+strings[1]+"&title="+strings[2]+"&context="+strings[3]+"&type="+strings[4];//보낼 정보. GET방식으로 작성. ex) "id=myid483&pwd=1234";
